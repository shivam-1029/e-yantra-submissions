...
// Double-buffering for rx to handle metastability
reg rx_sync_1 = 1'b1;  // First buffer stage
reg rx_sync_2 = 1'b1;  // Second buffer stage
wire rx_sync;           // Final synchronized rx signal

// Double-buffering of rx to prevent metastability
always @(posedge clk_3125) begin
    rx_sync_1 <= rx;        // First stage of buffering
    rx_sync_2 <= rx_sync_1; // Second stage of buffering
end

assign rx_sync = rx_sync_2; // Final synchronized signal
